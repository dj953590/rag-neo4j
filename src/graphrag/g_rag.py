...
class TKGS:
    """
    Main class for Graph Reasoning and Answering (GRAG) system.
    ...
    entity_summary_to_max_tokens: int = 750
    ...
    def insert(self, string_or_strings):
        """
        Insert one or more strings into the storage.

        Args:
            string_or_strings (str or List[str]): The string or a list of strings to be inserted.
        Returns:
                None
        """
